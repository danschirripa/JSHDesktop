...
public class TarEntry implements TarConstants {
	...
	/**
	 * This constructor added by Jeremy Wood. This lets you specify the path of
	 * a tar file. For example, if you only wanted to treat
	 * users/JoeSchmoe/Documents/x/y/z like "x/y/z", then you can.
	 */
	public TarEntry(File file, String name) {
		this();
		this.file = file;
	...
	public boolean isGNULongNameEntry() {
		...
		return name.toString().equals(GNU_LONGLINK);
	}
	...
	public void writeEntryHeader(byte[] outbuf) {
		...
		offset = TarUtils
				.getNameBytes(this.groupName, outbuf, offset, GNAMELEN);
