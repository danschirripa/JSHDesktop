 ...
 */
package jshdesktop.com.pump.data.branch;

import java.util.Collection;
import java.util.Map;

import jshdesktop.com.pump.data.BeanState;
 ...
 * Objects. If possible: it is preferred to use {@link jshdesktop.com.pump.data.Key keys}
 * to refer to the keys in these maps, because that offers type safety and
 * possible {@link jshdesktop.com.pump.data.BoundsChecker bounds checking}. But that is
...
public interface Branch<K> {
	 ...
	 * {@link jshdesktop.com.pump.data.Key#getBoundsCheckers() bounds checkers} to validate
	 * the incoming value.
	 * <p>
