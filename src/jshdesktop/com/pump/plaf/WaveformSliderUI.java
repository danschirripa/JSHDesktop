...
import jshdesktop.com.pump.audio.WavReader;
import jshdesktop.com.pump.geom.ShapeBounds;
import jshdesktop.com.pump.geom.TransformUtils;
import jshdesktop.com.pump.math.function.Function;
			...
			WavReader r = new WavReader(in) {
				...
				protected void processSamples(byte[] sample, int offset,
					...
					for (int a = offset; a < offset + length; a += sampleSize) {
						final int value = jshdesktop.com.pump.audio.PCMUtils.decodeSample(
