...
import jshdesktop.com.pump.blog.ResourceSample;
 ...
 * <table summary="Resource&#160;Samples&#160;for&#160;com.pump.swing.resources.MusicIcon">
 * <tr>
 * <td></td>
 * <td><img src=
...
public class MusicIcon implements Icon {
	...
	public static class PlayToggleIcon implements Icon {
		...
		final static Icon playIcon = new TriangleIcon(SwingConstants.EAST, 12,
				12, Color.white);
		final static Icon pressedPauseIcon = new PauseIcon(12, 12, new Color(
				160, 160, 160));
		...
		private void paintIcon(Graphics2D g) {
			...
			ellipse.setFrameFromCenter(centerX, centerY, centerX + radiusOuter
					+ 3, centerY + radiusOuter + 3);
			g.setStroke(new BasicStroke(1));
			g.setColor(new Color(0, 0, 0, 20));
			g.draw(ellipse);

			ellipse.setFrameFromCenter(centerX, centerY, centerX + radiusOuter
					+ 2, centerY + radiusOuter + 2);
			g.setColor(new Color(0, 0, 0, 50));
			g.draw(ellipse);

			ellipse.setFrameFromCenter(centerX, centerY, centerX + radiusOuter
					+ 1, centerY + radiusOuter + 1);
	...
	protected static Shape createEighthNotesShape() {
		GeneralPath circle1 = ShapeStringUtils
				.createGeneralPath("m 111.113 175.531 c 111.173 184.2 102.183 191.65 91.034 192.171 c 79.885 192.692 70.798 186.087 70.738 177.419 c 70.678 168.75 79.668 161.3 90.817 160.779 c 101.966 160.257 111.053 166.862 111.113 175.531 z");
		GeneralPath circle2 = ShapeStringUtils
				.createGeneralPath("m 173.579 164.139 c 173.638 172.808 165.467 180.258 154.318 180.779 c 143.169 181.3 134.082 174.695 134.022 166.027 c 133.962 157.358 142.952 149.908 154.101 149.387 c 165.25 148.865 173.519 155.47 173.579 164.139 z");
		GeneralPath polygon = ShapeStringUtils
				.createGeneralPath("m 99.31 73.824 l 173.592 62.328 l 173.592 163.322 l 164.175 174.311 l 164.175 95.261 l 111.188 103.947 l 111.188 175.11 l 99.31 183.286 l 99.31 73.824 z");
	...
	public MusicIcon(int width) {
		this(width, width, Math.min(width, PlayToggleIcon.DEFAULT_WIDTH), Math
				.min(width, PlayToggleIcon.DEFAULT_WIDTH));
	}
	...
	public void paintIcon(Component c, Graphics g0, int x, int y) {
		...
		g.setPaint(new RadialGradientPaint(new Point2D.Float(128, -20), 270,
				new float[] { 0, .3f, .6f, .9f }, new Color[] {
						new Color(140, 140, 140), new Color(100, 100, 100),
						new Color(50, 50, 50), Color.black }));
		...
		// the shape
		g.setPaint(new GradientPaint(80, 190, new Color(105, 122, 141), 170,
				65, new Color(182, 186, 194)));
		...
		playToggleIcon.paintIcon(c, g,
				x + getIconWidth() / 2 - playToggleIcon.getIconWidth() / 2, y
						+ getIconHeight() / 2 - playToggleIcon.getIconHeight()
						/ 2);
		g.dispose();
	}
}