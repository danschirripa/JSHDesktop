...
import jshdesktop.com.pump.image.gif.lzw.LZWInputStream;
import jshdesktop.com.pump.image.gif.lzw.LZWOutputStream;
import jshdesktop.com.pump.image.pixel.IndexedBytePixelIterator;
import jshdesktop.com.pump.image.pixel.quantize.ColorLUT;
import jshdesktop.com.pump.image.pixel.quantize.ImageQuantization;
 ...
 * {@link jshdesktop.com.pump.image.gif.block.GifGraphicRenderingBlock}, because it is, by
 * itself, meaningless. It must be preceded by a
 * {@link jshdesktop.com.pump.image.gif.block.GifImageDescriptor} block; so that is
