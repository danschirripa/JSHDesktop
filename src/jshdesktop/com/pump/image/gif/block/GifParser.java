 ...
 */
package jshdesktop.com.pump.image.gif.block;
 ...
 * {@link jshdesktop.com.pump.image.gif.block.GifBlock}'s.
 */
public class GifParser {
	...
	/**
	 * This reads the next {@link jshdesktop.com.pump.image.gif.block.GifBlock}
	 * <P>
	 * Note that if this method returns a <code>APPLICATION_EXTENSION</code>, it
	 * may be a {@link jshdesktop.com.pump.image.gif.block.GifLoopingApplicationExtension}
	 * or a {@link jshdesktop.com.pump.image.gif.block.GifApplicationExtension}.
	 * 
	 * @return the next {@link jshdesktop.com.pump.image.gif.block.GifBlock}, or
	...
	/**
	 * @return a field from {@link jshdesktop.com.pump.image.gif.block.GifBlock}, or
	 ...
	 *         {@link jshdesktop.com.pump.image.gif.block.GifBlock}s available to read.
	 * @throws IOException
	 *             if an IO problem occurs.
	 */
