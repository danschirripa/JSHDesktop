...
public abstract class GenericImageSinglePassIterator implements PixelIterator {
	 ...
	 * {@link jshdesktop.com.pump.image.bmp.BmpEncoder} class. This can write an image to a
	 * <code>RandomAccessFile</code> in multiple arbitrary passes as a BMP, and
	 * then the {@link jshdesktop.com.pump.image.bmp.BmpDecoder} can read the final image
	 * back in a {@link jshdesktop.com.pump.image.pixel.PixelIterator}.
	 */
