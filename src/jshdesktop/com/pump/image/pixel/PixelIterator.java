 ...
 */
package jshdesktop.com.pump.image.pixel;

/**
 * This iterates over an image, one row of pixels at a time.
 * <P>
 * Note this interface is not complete by itself: the
 * {@link jshdesktop.com.pump.image.pixel.BytePixelIterator} and the
 * {@link jshdesktop.com.pump.image.pixel.IntPixelIterator} interfaces add the crucial
...
public interface PixelIterator {
	 ...
	 * in the subinterfaces: {@link jshdesktop.com.pump.image.pixel.BytePixelIterator} and
	 * {@link jshdesktop.com.pump.image.pixel.IntPixelIterator}.
	 * <P>
	 * You should <i>not</i> assume you know what this value is. For example: If
	 * an iterator is actually a 4-byte iterator that is reducing to a 3-byte
