 ...
 */
package jshdesktop.com.pump.animation.quicktime.atom;
...
import jshdesktop.com.pump.io.GuardedOutputStream;
import jshdesktop.com.pump.io.NullOutputStream;
import jshdesktop.javax.media.jai.PerspectiveTransform;
...
public abstract class Atom implements TreeNode {
	...
	protected static void read(InputStream in, byte[] array, int offset,
	...
	protected synchronized static final int read24Int(InputStream in)
		...
		long k = (((long) (array3[0] & 0xff)) << 16)
				+ (((long) (array3[1] & 0xff)) << 8) + (((array3[2] & 0xff)));
		return (int) k;
	}
	...
	protected static final long QT_TO_JAVA_MS_CHANGE = (new GregorianCalendar(
			1970, GregorianCalendar.JANUARY, 1)).getTimeInMillis()
	...
	/**
	 * Returns the complete size of this atom, including the 8 byte header that
	 * is not written in the <code>writeContents</code> method.
	 * <P>
	 * Subclasses are encouraged to override this method if it is easy to
	 * calculate the number of bytes that will be written. By default this
	 * method uses a <code>NullOutputStream</code> to actually write the data
	 ...
	 * <P>
	 * (The first 8 bytes are always the size of this atom, and its identifier.
	 ...
	 * <code>TrackHeaderAtoms</code> and determine the highest track ID used in
	 * this movie
	 * 
