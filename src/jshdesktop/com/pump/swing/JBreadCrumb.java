 ...
 * 
 * @see <a href=
 *      "https://javagraphics.blogspot.com/2014/01/navigation-breadcrumbs.html">Navigation:
 *      Bread Crumbs</a>
 */
public class JBreadCrumb<T> extends JComponent {
	...
	/**
	 * Each bread crumb is represented by a JLabel, and this gives you the
	 * opportunity to format that label. For example, if this component navigated
	 * <code>java.io.Files</code>, then you should apply a
	 * <code>BreadCrumbFormatter</code> that invoked
	 * <code>label.setText(file.getName())</code> and
	 * <code>label.setIcon(fileIcon)</code>.
	 */
	public static interface BreadCrumbFormatter<T> {
		/**
		 * Format a label to accommodate the path node (crumb) provided.
		 * <p>
		 * For example: this might add specific icons, or change the font or opacity
		 * based on what this label is representing.
		 * 
	...
	/**
	 * Add a <code>PropertyChangeListener</code> for this key to be notified when
	 * the current path changes.
	 * 
	 */
	 ...
	 * 
	 * @param path the path to display. This should not be null, or contain any null
	 *             elements.
	 */
	...
	/**
	 * Return the current path of this component. This may be null if it has not
	 * been defined yet.
	 */
	public T[] getPath() {
	...
	/**
	 * Assign the <code>BreadCrumbFormatter</code> for this component.
	 */
