...
/**
 * <P>
 * This listens to the parent window and makes important changes to the child
 * window to best emulate a "sheet-like" dialog.
 * <P>
 * If the parent is resized: then the dialog needs to be repositioned and the
 * modal cover needs to be resized.
 * <P>
 * When the parent window is dragged, this drags the other window an identical
 * (+dx, +dy).
 * <P>
 * This class is flawed, though, because on Mac the componentResized events are
 * coalesced together, and therefore the second window moves in spurts and
 * jumps. But I don't see how else to implement this without actual sheets.
 */
class FakeSheetWindowListener implements ComponentListener {
	...
	public void componentMoved(ComponentEvent e) {
		...
		translate(window2, newLocation.x - lastLocation.x, newLocation.y
				- lastLocation.y);
