...
import jshdesktop.com.pump.awt.SplayedLayout;
import jshdesktop.com.pump.icon.IconUtils;
import jshdesktop.com.pump.icon.PlusIcon;
import jshdesktop.com.pump.inspector.Inspector;
import jshdesktop.com.pump.plaf.BoxTabbedPaneUI;
...
public class BoxTabbedPaneUIDemo extends ShowcaseExampleDemo {
	...
	JButton addButton = new JButton(IconUtils.createPaddedIcon(
	...
	public BoxTabbedPaneUIDemo() {
		...
		hideSingleActive.setToolTipText(
				"Hide row of tabs when there is only one tab showing.");

		closeableActive.setToolTipText(
				"Include a button to close tabs (visible only on rollover).");
		...
		ActionListener hideSingleListener = new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				tabs.putClientProperty(BoxTabbedPaneUI.PROPERTY_HIDE_SINGLE_TAB,
