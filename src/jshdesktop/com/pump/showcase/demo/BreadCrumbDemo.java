...
import jshdesktop.com.pump.icon.EmptyIcon;
...
public class BreadCrumbDemo extends ShowcaseExampleDemo {
	...
	static class RoundedShadowIcon implements Icon {
		...
		public RoundedShadowIcon() {
			...
			scratch = new BufferedImage(
					separatorWidth + leftPadding + rightPadding, 26,
			...
			int k = 5;
			chunk.curveTo(leftPadding + k, k, leftPadding + k,
					getIconHeight() - k, leftPadding, getIconHeight());
	...
	public static TreeNode createTree() {
		DefaultMutableTreeNode fictionBooks = new DefaultMutableTreeNode(
				"Fiction Books");
		DefaultMutableTreeNode douglasAdams = add(fictionBooks,
				"Douglas Adams");
	...
	public BreadCrumbDemo() {
		...
		breadCrumb.setBorder(new CompoundBorder(new LineBorder(Color.lightGray),
