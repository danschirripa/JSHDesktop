...
import jshdesktop.com.pump.swing.popup.QPopup;
import jshdesktop.com.pump.swing.popup.QPopupFactory;
...
public class JToolTipDemo extends ShowcaseExampleDemo {
	...
	protected void refreshUI() {
		...
		if (toolTipTypeComboBox.getSelectedIndex() == 1) {
			...
			qPopupFactory.setToolTipCallout(
					!NONE.equals(calloutTypeComboBox.getSelectedItem()));
		...
		ToolTipManager.sharedInstance()
				.setEnabled(toolTipTypeComboBox.getSelectedIndex() != 2);
		...
		try {
			type = CalloutType
					.valueOf((String) calloutTypeComboBox.getSelectedItem());
		} catch (Exception e) {
		}
