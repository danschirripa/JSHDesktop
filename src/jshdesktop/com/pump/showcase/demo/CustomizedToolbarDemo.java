...
import jshdesktop.com.pump.plaf.TexturePaintPanelUI;
import jshdesktop.com.pump.swing.PartialLineBorder;
import jshdesktop.com.pump.swing.toolbar.CustomizedToolbar;
...
public class CustomizedToolbarDemo extends ShowcaseDemo {
	...
	public CustomizedToolbarDemo() {
		...
		fluff.setBorder(
				new PartialLineBorder(Color.lightGray, new Insets(1, 0, 0, 0)));
