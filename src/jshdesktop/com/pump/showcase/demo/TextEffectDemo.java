...
import jshdesktop.com.pump.awt.Scribbler;
import jshdesktop.com.pump.awt.text.BlockLetter;
import jshdesktop.com.pump.awt.text.ExplodeTextEffect;
import jshdesktop.com.pump.awt.text.OutlineTextEffect;
import jshdesktop.com.pump.awt.text.PunchTextEffect;
import jshdesktop.com.pump.awt.text.TextEffect;
import jshdesktop.com.pump.awt.text.WaveTextEffect;
import jshdesktop.com.pump.awt.text.WriteTextEffect;
import jshdesktop.com.pump.awt.text.writing.WritingFont;
import jshdesktop.com.pump.inspector.AnimatingInspectorPanel;
import jshdesktop.com.pump.inspector.Inspector;
import jshdesktop.com.pump.swing.AnimationController;
import jshdesktop.com.pump.swing.FontComboBox;
import jshdesktop.com.pump.swing.JColorWell;
import jshdesktop.com.pump.swing.PartialLineBorder;
...
public class TextEffectDemo extends ShowcaseExampleDemo {
	...
	class PreviewPanel extends JPanel {
		...
		protected void paintComponent(Graphics g0) {
			...
			if (effect != null) {
				...
				float fraction = (float) (controller.getTime()
	...
	public TextEffectDemo() {
		...
		preview.setBorder(
				new PartialLineBorder(Color.gray, true, true, false, true));
		...
		fontCalligraphy.setToolTipText(
				"This doesn't support capital letters yet, sorry.");
	...
	private void refreshControls() {
		...
		if ("Outline".equals(effectName)) {
			effect = new OutlineTextEffect(getEffectFont(), text,
					...
					fill.getColorSelectionModel().getSelectedColor(),
			...
			WritingFont font = fontComicNeue.isSelected()
					? WritingFont.COMIC_NEUE
