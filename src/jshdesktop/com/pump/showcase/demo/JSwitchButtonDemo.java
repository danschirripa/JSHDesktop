...
import jshdesktop.com.pump.icon.AquaSwitchButtonIcon;
import jshdesktop.com.pump.icon.WindowsSwitchButtonIcon;
import jshdesktop.com.pump.inspector.Inspector;
import jshdesktop.com.pump.plaf.button.SwitchButtonUI;
...
public class JSwitchButtonDemo extends ShowcaseExampleDemo {
	...
	JComboBox<String> iconType = new JComboBox<String>(
			new String[] { "Aqua", "Windows" });
