...
import jshdesktop.com.pump.desktop.DesktopHelper;
import jshdesktop.com.pump.desktop.DesktopHelper.FileOperation;
import jshdesktop.com.pump.desktop.DesktopHelper.FileOperationType;
import jshdesktop.com.pump.desktop.temp.TempFileManager;
import jshdesktop.com.pump.inspector.ControlGridLayout;
...
public class DesktopHelperDemo extends ShowcaseExampleDemo {
	...
	JRadioButton moveToTrash = new JRadioButton(
			"Move File to " + (JVM.isWindows ? "Recycle Bin" : "Trash"), false);
	...
	public DesktopHelperDemo() {
		...
		executeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FileOperationType type = reveal.isSelected()
